...
import org.theonionphone.common.exceptions.CodecException;

public class Codec2 implements Codec {
	
	private static final int SAMPLES_SIZE = 160;
	private static final int BYTES_SIZE = 7;
	private static final int CODEC_TYPE = 69;	//there isn't any official payload type defined for codec2, so we just use any not-reserved value
